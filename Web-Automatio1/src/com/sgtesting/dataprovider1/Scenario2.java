...
public class Scenario2 {
	...
	{
		return new Object[][] {{"Vishwa","H","Vishwa@gmail.com","VishwaH","Welcome123","Welcome123"}};
	}
	...
	public static void ModifyUser(String username)
	{
		try 
		{
			...
			Thread.sleep(1000);
			wb.findElement(By.id("userDataLightBox_usernameField")).clear();
			Thread.sleep(1000);
			wb.findElement(By.id("userDataLightBox_usernameField")).sendKeys(username);
			Thread.sleep(1000);
